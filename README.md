...
| WhirlpoolMagicool2 | 120 | Whirlpool | AC | A second Magicool remote with a wholly different NEC-style wire format: power, mode (cool/dry/fan), temp, fan, 5-step + full swing, 6th-sense, turbo, eco, sleep, dim; 15-byte frame, nibble-sum checksum. Reverse-engineered (not in IRremoteESP8266) |
